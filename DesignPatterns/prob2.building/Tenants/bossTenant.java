...
public class bossTenant implements observer, tenantBehavior{
    
    private int monthly;
    private String room;
    private ArrayList<String> options = new ArrayList<String>();
    
    public bossTenant(subject Building, int monthly, String room){
    ...
    public void call(){
        System.out.print("I am Boss! " + speakRoom() + speakMonthly() + speakOptions());
    }
